...
namespace Waterbill
{
    internal class Waterbill
    {
        ...
        public Waterbill(string Fullnames, string plo, string add, double Kl, double klamount, double wasterwater, double TotalAMOUNT)
        {
            Name = Fullnames;
            plot = plo;
            address = add;
    ...
    internal class WaterBilltest
    {
        static void Main(string[] args)
        {
            ...
            outputFile.WriteLine("****");
            Console.WriteLine();
            Console.WriteLine("Please Enter Names in Full :");
            waterbill.Name = Console.ReadLine();
            outputFile.WriteLine("Name" + waterbill.Name);
            Console.WriteLine("Please Enter Residential Area");
            waterbill.plot = Console.ReadLine();
            outputFile.WriteLine("Residence " + waterbill.plot);
            Console.WriteLine("Please Enter Address Plot");
            waterbill.address = Console.ReadLine();
